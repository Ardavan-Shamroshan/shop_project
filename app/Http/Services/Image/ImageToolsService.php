...
class ImageToolsService {
     ...
     *     ------------------------------- --------------
     *        exclusive dir     image dir     name    format
     *     -------------------- ----------- ---------- ----
     * ../ images/post-category /2021/10/1/ 1634399399 .jpg
     */
    protected $image;
     ...
     * @return void
     *
     * creates uploaded-images directory, name and format.
     */
     ...
     * @return mixed|void
     *
     * returns back the specific current image
     * Laravel : $this->image->getClientOriginalName() ~ php : $_FILES['image']['name']
     */
