...
class PropertyController extends Controller
{
    ...
    public function store(CategoryAttributeRequest $request)
    {
        ...
        return redirect()->route('admin.market.property')->with('swal-success', 'فرم جدید شما با موفقیت ثبت شد');
    }
    ...
    public function update(CategoryAttributeRequest $request, CategoryAttribute $attribute)
    {
        ...
        return redirect()->route('admin.market.property')->with('swal-success', 'فرم جدید شما با موفقیت ویرایش شد');
    ...
    {
        $attribute->delete();
        return redirect()->route('admin.market.property')->with('swal-success', 'فرم جدید شما با موفقیت حذف شد');
    }
}
