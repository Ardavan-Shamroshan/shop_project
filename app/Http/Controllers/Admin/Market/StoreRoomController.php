...
class StoreRoomController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.market.storeroom.index', compact('products'));
    }
    ...
    {
        return view('admin.market.storeroom.add-to-store', compact('product'));
    }
    ...
    public function store(StoreRequest $request, Product $product)
    {
        ...
        return redirect()->route('admin.market.storeroom')->with('swal-success', 'موجودی جدید با موفقیت ثبت شد');
    }
    ...
    {
        return view('admin.market.storeroom.edit', compact('product'));
