...
class SMSController extends Controller {
    ...
    public function store(SMSRequest $request) {
        ...
        return redirect(route('admin.notify.sms'))->with('swal-success', 'پیامک شما با موفقیت ثبت شد');
    }
    ...
    public function update(SMSRequest $request, SMS $sms) {
        ...
        $inputs['published_at'] = date('Y-m-d H:i:s', (int)$realTimestampStart);
        $sms->update($inputs);
        return redirect(route('admin.notify.sms'))->with('swal-success', 'پیامک شما با موفقیت ویرایش شد');
    ...
    public function destroy(SMS $sms) {
        $sms->delete();
        return redirect(route('admin.notify.sms'))->with('swal-success', 'پیامک با موفقیت حذف شد');
    }
