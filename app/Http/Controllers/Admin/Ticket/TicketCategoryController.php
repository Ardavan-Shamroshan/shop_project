...
class TicketCategoryController extends Controller {
    ...
    public function store(TicketCategoryRequest $request) {
        ...
        return redirect()->route('admin.ticket.category')->with('swal-success', 'دسته بندی جدید شما با موفقیت ثبت شد');
    }
    ...
    public function update(TicketCategoryRequest $request, TicketCategory $ticketCategory) {
        ...
        return redirect()->route('admin.ticket.category')->with('swal-success', 'دسته بندی شما با موفقیت ویرایش شد');
    }
    ...
    public function destroy(TicketCategory $ticketCategory) {
        ...
        return redirect()->route('admin.ticket.category')->with('swal-success', 'دسته بندی شما با موفقیت حذف شد');
    }
