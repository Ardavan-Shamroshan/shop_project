...
class PageController extends Controller {
    ...
    public function store(PageRequest $request) {
        $inputs = $request->all();
        Page::query()->create($inputs);
        return redirect(route('admin.content.page'))->with('swal-success', 'صفحه با موفقیت ثبت شد');
    }
    ...
    public function update(PageRequest $request, Page $page) {
        ...
        $page->slug = null;
        $page->update($inputs);
        return redirect(route('admin.content.page'))->with('swal-success', 'صفحه با موفقیت ویرایش شد');
    }
    ...
    public function destroy(Page $page) {
        $page->delete();
        return redirect(route('admin.content.page'))->with('swal-success', 'صفحه با موفقیت حذف شد');
    }
