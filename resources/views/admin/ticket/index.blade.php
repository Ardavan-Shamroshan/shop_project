                    ...
                    @forelse($tickets as $ticket)
                        <tr>
                            ...
                            <td class="width-16-rem text-left">
                                <a href="{{ route('admin.ticket.show', $ticket->id) }}" class="btn btn-info  border rounded-pill  btn-hover color-9"><i class="fa fa-eye font-size-12"></i> مشاهده</a>
                                <a href="{{ route('admin.ticket.change', $ticket->id) }}" class="btn btn-info  border rounded-pill  btn-hover {{ $ticket->status == 1 ? 'color-5' : 'color-11' }}"><i class="fa {{ $ticket->status == 1 ? 'fa-check-circle' : 'fa-times-circle' }} "></i>
