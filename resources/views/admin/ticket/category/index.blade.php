                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach ($ticketCategories as $key => $ticketCategory)
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input id="{{ $ticketCategory->id }}" onchange="changeStatus({{ $ticketCategory->id }})" data-url="{{ route('admin.ticket.category.status', $ticketCategory->id) }}" type="checkbox" @if ($ticketCategory->status === 1)checked @endif>
                                    </label>
                                </td>
                                <td class="width-16-rem text-left">
                                    <a href="{{ route('admin.ticket.category.edit', $ticketCategory->id) }}" class="btn btn-primary btn-sm btn-hover border rounded-pill color-9"><i class="fa fa-pen font-size-12"></i> ویرایش</a>
