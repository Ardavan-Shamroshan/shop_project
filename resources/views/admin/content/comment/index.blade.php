                ...
                @forelse($comments as $key => $comment)
                    <tr>
                        ...
                        <td class="width-16-rem text-left">
                            <a href="{{ route('admin.content.comment.show', $comment->id) }}" class="btn btn-info  border rounded-pill  btn-hover color-9"><i class="fa fa-eye font-size-12"></i> نمایش</a>
                            @if($comment->approved == 0)
                                <a type="submit" href="{{ route('admin.content.comment.approved', $comment->id) }}" class="btn btn-warning  border btn-hover color-4 rounded-pill"><i class="fa fa-clock"></i> در انتظار تایید</a>
                            @elseif($comment->approved == 1)
                                <a type="submit" href="{{ route('admin.content.comment.approved', $comment->id) }}" class="btn btn-success  btn-hover color-5 text-white border rounded-pill "><i class="fa fa-check"></i> تایید</a>
                            @endif
                        </td>
                    </tr>
                @empty @endforelse
