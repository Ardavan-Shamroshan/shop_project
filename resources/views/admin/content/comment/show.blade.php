...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 p-0"><a href="{{ route('admin.content.comment') }}">نظرات</a></li>
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.content.comment') }}" class="btn btn-info btn-sm border rounded-pill btn-sm btn-hover color-8">« بازگشت</a>
        </section>
        ...
        <section class="card mb-3 mx-5">
            ...
            <section class="card-body">
                <section class="d-flex justify-content-between">
                    <h5 class="card-title"><b>عنوان پست :</b>
                        <a href="{{ route('admin.content.post.show', $comment->commentable->id) }}" class="show-link"> {{ $comment->commentable->title }} </a>
                    </h5>
                    <p class="my-2 mx-2"><b> کد پست :</b> {{ $comment->commentable_id }}</p>
                </section>
