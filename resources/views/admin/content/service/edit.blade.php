...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.content.service') }}" class="btn btn-info btn-sm border rounded-pill btn-sm btn-hover color-8">« بازگشت</a>
        </section>
                ...
                <section class="row">
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm @error('title') border border-danger @enderror" name="title" id="title" value="{{ old('title', $service->title) }}">
                        </div>
                    </section>
                    ...
                    <section class="col-12 col-md-2">
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control form-control-sm @error('status') border border-danger @enderror">
                                <option value="0" @if(old('status', $service->status) == 0) selected @endif>غیر فعال</option>
                    ...
                    <section class="col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <textarea type="text" class="form-control form-control-sm @error('summary') border border-danger @enderror" name="summary" id="summary" rows="8"> {{ old('summary', $service->summary) }} </textarea>
                        </div>
                    </section>
                                ...
                                <section class="col-md-{{ 6 / $number }}">
                                    <div class="form-check pl-0 py-2 border border-gray rounded text-capitalize text-center shadow-sm">
                                        <input type="radio" class="form-check-input" value="{{ $key }}" id="{{ $number }}"
                                               name="currentImage" @if($service->image['currentImage'] == $key) checked @endif>
                    ...
                    <section class="col-12">
                        <div class="form-group">
                            ...
                            @enderror
                            <textarea type="text" class="form-control form-control-sm @error('body') border border-danger @enderror" name="body" id="service_body"> {{ old('body', $service->body) }} </textarea>
                        </div>
                    </section>
