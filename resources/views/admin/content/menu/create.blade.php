...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 p-0 rounded-pill"> ایجاد منو جدید</li>
        </ol>
    </nav>
    <section class="main-body-container">
        <section class="main-body-container-header"><h4>ایجاد منو جدید</h4></section>
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.content.menu') }}" class="btn btn-info btn-sm border rounded-pill btn-sm btn-hover color-8">« بازگشت</a>
        </section>
        <section>
                ...
                <section class="row">
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control @error('name') border border-danger @enderror" name="name" value="{{ old('name') }}">
                        </div>
                    </section>
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @forelse($parentMenus as $parentMenu)
                                    <option value="{{ $parentMenu->id }}" @if(old('parent_id') == $parentMenu->id) selected @endif>{{ $parentMenu->name }}</option>
                                @empty @endforelse
                            </select>
                        </div>
                    </section>
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control @error('url') border border-danger @enderror" name="url" value="{{ old('url') }}" placeholder="مثال: example.com">
                        </div>
                    </section>
