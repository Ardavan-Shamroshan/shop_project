    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="{{ route('admin.content.banner.create') }}" class="btn btn-info  border rounded-pill  btn-hover color-8">ایجاد بنر </a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="shadow-sm text-center">
                                <img src="{{ asset($banner->image) }}" alt="عکس" width="70" height="50" class="border">
                            </td>
                            <td>
                                <label>
                                    <input id="{{ $banner->id }}" onchange="changeStatus({{ $banner->id }})" data-url="{{ route('admin.content.banner.status', $banner->id) }}" type="checkbox" @if ($banner->status === 1) checked @endif>
                                </label>
                            </td>
                            ...
                            <td class="width-16-rem text-left">
                                ...
                                <form class="d-inline" action="{{ route('admin.content.banner.destroy', $banner->id) }}" method="post">
                                    @csrf
                                    @method('delete')
                                <button class="btn btn-danger  delete border rounded-pill  btn-hover color-11" type="submit"><i class="fa fa-times"></i> حذف</button>
                            </form>
                            </td>
                        </tr>
                        @empty @endforelse
