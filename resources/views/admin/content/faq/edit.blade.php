...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-dot">
            ...
            <li class="breadcrumb-item font-size-12 p-0" aria-current="page"><a href="{{ route('admin.content.faq') }}">سوالات متداول</a></li>
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.content.faq') }}" class="btn btn-info btn-sm border rounded-pill btn-hover color-8">« بازگشت</a>
        </section>
        <section>
                ...
                <section class="row">
                    <section class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="hidden" class="form-control form-control-sm @error('tags') border border-danger @enderror" name="tags" id="tags" value="{{ old('tags', $faq->tags) }}">
