...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.content.page.create') }}" class="btn btn-info  border rounded-pill  btn-hover color-8">ایجاد پیج جدید</a>
                ...
                @forelse($pages as $key => $page)
                    <tr>
                        ...
                        <td class="width-16-rem text-left">
                            <a href="{{ route('admin.content.page.edit', $page->id) }}" class="btn btn-primary  border rounded-pill  btn-hover color-9"><i class="fa fa-pen font-size-12"></i>
                                ویرایش </a>
