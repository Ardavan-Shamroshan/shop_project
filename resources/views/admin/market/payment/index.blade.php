            ...
            <table class="table table-striped table-hover h-150">
                ...
                <tr>
                    ...
                    <td class="width-22-rem text-left">
                        <a href="{{ route('admin.market.payment.show', $payment->id) }}" class="btn btn-primary  border rounded-lg  btn-hover color-9"><i class="fa fa-eye font-size-12"></i> مشاهده </a>
                        <a href="{{ route('admin.market.payment.canceled', $payment->id) }}" class="btn btn-primary  border rounded-lg  btn-hover color-11"><i class="fa fa-unlink font-size-12"></i> باطل کردن </a>
                        <a href="{{ route('admin.market.payment.returned', $payment->id) }}" class="btn btn-primary  border rounded-lg  btn-hover color-4"><i class="fa fa-retweet font-size-12"></i> برگرداندن </a>
                    </td>
                </tr>
                @empty @endforelse
           </table>
