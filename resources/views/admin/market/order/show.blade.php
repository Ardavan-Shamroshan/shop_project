            ...
            <table class="table table-striped h-150px" id="printable">
                ...
                <tr>
                    ...
                    <td class="width-16-rem text-left">
                        <a href="#" class="btn  btn-hover btn-dark rounded-lg border" id="print"><i class="fa fa-print"></i> چاپ</a>
                        <a href="{{ route('admin.market.order.show.detail', $order->id) }}" class="btn  btn-hover color-9 rounded-lg border"><i class="fa fa-book"></i> جزئیات سفارش</a>
                    </td>
                </tr>
                <tr>
                    <th> نام مشتری</th>
