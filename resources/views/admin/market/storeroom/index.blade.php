...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="#" class="btn btn-info btn-sm border rounded-pill btn-hover color-8 disabled">ایجاد انبار جدید</a>
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        <td class="width-22-rem text-left">
                            <a href="{{ route('admin.market.storeroom.addToStore', $product->id) }}" class="btn btn-primary btn-sm border rounded-pill btn-hover color-5"><i class="fa fa-plus-circle font-size-12"></i>
                                افزایش موجودی </a>
                            <a href="{{ route('admin.market.storeroom.edit', $product->id) }}" class="btn btn-danger btn-sm border rounded-pill btn-hover color-4"><i class="fa fa-pen font-size-12 rounded-pill"></i>
                                اصلاح موجودی </a>
                        </td>
                    </tr>
                @endforeach
