...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="" class="btn btn-info btn-sm disabled border rounded-lg btn-sm btn-hover color-8">ایجاد نظر جدید</a>
                ...
                @forelse ($comments as  $comment)
                    <tr>
                        ...
                        <td class="width-16-rem text-left">
                            <a href="{{ route('admin.market.comment.show', $comment->id) }}" class="btn btn-info btn-sm border rounded-lg btn-sm btn-hover color-9"><i class="fa fa-eye font-size-12"></i> نمایش </a>
                            @if($comment->approved == 1)
                                <a href="{{ route('admin.market.comment.approved', $comment->id)}}" class="btn btn-success btn-sm btn-hover color-5 text-white border rounded-lg btn-sm" type="submit"><i class="fa fa-check"></i> تایید </a>
                            @else
                                <a href="{{ route('admin.market.comment.approved', $comment->id)}}" class="btn btn-warning btn-sm border btn-hover color-4 rounded-lg" type="submit"><i class="fa fa-check"></i> درانتظار تایید </a>
                            @endif
                        </td>
