...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.market.property.value.create', $attribute->id) }}" class="btn btn-info btn-sm border rounded-pill btn-sm btn-hover color-8">ایجاد
                ...
                @forelse($attribute->values as $value)
                    <tr>
                        ...
                        <td class="width-22-rem text-left">
                            <a href="{{ route('admin.market.property.value.edit', ['attribute' => $attribute->id, 'value' => $value->id]) }}" class="btn btn-primary btn-sm border rounded-pill btn-sm btn-hover color-9"><i class="fa fa-pen font-size-12"></i> ویرایش</a>
