...
@section('content')
    ...
    <section class="main-body-container">
        <section class="main-body-container-header"><h4>ایجاد مقدار فرم کالا</h4></section>
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.market.property.value', $attribute->id) }}" class="btn btn-info btn-sm border rounded-pill btn-sm btn-hover color-8">« بازگشت</a>
        </section>
        <section>
            <form action="{{ route('admin.market.property.value.store', $attribute->id) }}" method="post" enctype="multipart/form-data" id="form">
                @csrf
                <section class="row">
                    ...
                    <section class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm @error('value') border border-danger @enderror" name="value" id="value" value="{{ old('value') }}">
                        </div>
                    </section>
