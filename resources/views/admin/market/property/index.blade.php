...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.market.property.create') }}" class="btn btn-info btn-sm border rounded-pill btn-hover color-8">ایجاد فرم کالای جدید</a>
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td class="width-22-rem text-left">
                        <a href="{{ route('admin.market.property.value', $attribute->id) }}" class="btn btn-primary btn-sm border rounded-pill btn-hover color-4"><i class="fa fa-project-diagram font-size-12"></i> ویژگی ها </a>
                        <a href="{{ route('admin.market.property.edit', $attribute->id) }}" class="btn btn-primary btn-sm border rounded-pill btn-hover color-9"><i class="fa fa-pen font-size-12"></i> ویرایش </a>
