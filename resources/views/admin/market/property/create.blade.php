...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.market.property') }}" class="btn btn-info btn-sm border rounded-pill btn-hover color-8">«
                بازگشت</a>
        </section>
        <section>
                ...
                <section class="row">
                    ...
                    <section class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm @error('unit') border border-danger @enderror" name="unit" id="unit" value="{{ old('unit') }}">
                        </div>
                    </section>
