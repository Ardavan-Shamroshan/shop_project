...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.market.brand.create') }}" class="btn btn-info  border rounded-lg  btn-hover color-8">ایجاد برند جدید</a>
                    ...
                    <tr>
                        ...
                        <td class="width-16-rem text-left">
                            <a href="{{ route('admin.market.brand.edit', $brand->id) }}"
                               class="btn btn-primary  border rounded-lg  btn-hover color-9"><i class="fa fa-pen font-size-12"></i> ویرایش </a>
