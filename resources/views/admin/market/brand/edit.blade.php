                ...
                <section class="row">
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text"
                                   class="form-control form-control-sm @error('original_name') border border-danger @enderror"
                                   name="original_name" id="original_name"
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="hidden"
                                   ...
                                   name="tags" id="tags" value="{{ old('tags', $brand->tags) }}">
                    ...
                    <section class="col-md-6 my-4">
                        <section class="row">
                            @php
                                $number = 1;
                            @endphp
                            @forelse ($brand->logo['indexArray'] as $key => $value)
