...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section>
            <form action="{{ route('admin.market.discount.amazingSale.update', $amazingSale->id) }}" method="post" enctype="multipart/form-data" id="form">
                @csrf
                @method('put')
                <section class="row">
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm @error('percentage') border border-danger @enderror" name="percentage" id="percentage" value="{{ old('percentage', $amazingSale->percentage) }}">
                        </div>
                    </section>
