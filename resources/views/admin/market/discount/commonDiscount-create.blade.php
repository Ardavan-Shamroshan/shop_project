...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ایجاد تخفیف عمومی جدید</li>
        </ol>
    </nav>
    <section class="main-body-container pb-5">
        <section class="main-body-container-header"><h4>ایجاد تخفیف عمومی جدید</h4></section>
        ...
        <section>
            <form action="{{ route('admin.market.discount.commonDiscount.store') }}" method="post" enctype="multipart/form-data" id="form">
                @csrf
                <section class="row">
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm @error('minimal_order_amount') border border-danger @enderror" name="minimal_order_amount" id="minimal_order_amount" value="{{ old('minimal_order_amount') }}">
                        </div>
                    </section>
