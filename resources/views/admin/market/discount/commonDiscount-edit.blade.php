...
@section('content')
    ...
    <section class="main-body-container pb-5">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.market.discount.commonDiscount') }}" class="btn btn-info  border rounded-lg  btn-hover color-8">« بازگشت</a>
        </section>
        <section>
                ...
                <section class="row">
                    ...
                    <section class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" name="start_date" id="start_date" class="form-control form-control-sm d-none" value="{{ old('start_date', $commonDiscount->start_date) }}">
                            <input type="text" id="start_date_view" class="form-control form-control-sm @error('start_date') border border-danger @enderror" value="{{ old('start_date', $commonDiscount->start_date) }}">
                        </div>
                    </section>
                    <section class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" name="end_date" id="end_date" class="form-control form-control-sm d-none" value="{{ old('end_date', $commonDiscount->end_date) }}">
                            <input type="text" id="end_date_view" class="form-control form-control-sm @error('end_date') border border-danger @enderror" value="{{ old('end_date', $commonDiscount->end_date) }}">
                        </div>
                    </section>
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm @error('discount_ceiling') border border-danger @enderror" name="discount_ceiling" id="discount_ceiling" value="{{ old('discount_ceiling', $commonDiscount->discount_ceiling) }}">
                        </div>
                    </section>
