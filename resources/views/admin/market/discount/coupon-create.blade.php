...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 p-0"><a href="{{ route('admin.market.discount.coupon') }}"> کوپن های
                    تخفیف</a></li>
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ایجاد کوپن تخفیف جدید</li>
        </ol>
    </nav>
    <section class="main-body-container">
        <section class="main-body-container-header"><h4>ایجاد کوپن تخفیف جدید</h4></section>
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.market.discount.coupon') }}" class="btn btn-info btn-sm border rounded-lg btn-sm btn-hover color-8">«
                بازگشت</a>
        </section>
        <section>
            <form action="{{ route('admin.market.discount.coupon.store') }}" method="post" enctype="multipart/form-data" id="form">
                @csrf
                <section class="row">
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm @error('code') border border-danger @enderror" name="code" id="code" value="{{ old('code') }}">
                        </div>
                    </section>
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm @error('amount') border border-danger @enderror" name="amount" id="amount" value="{{ old('amount') }}">
                        </div>
                    </section>
                    <section class="col-12 col-md-6">
                        <div class="form-group">
