...
@section('content')
    ...
    <section class="main-body-container">
        <section class="main-body-container-header"><h4>ایجاد اطلاعیه ایمیلی</h4></section>
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.notify.email') }}" class="btn btn-info  border rounded-pill  btn-hover color-8">« بازگشت</a>
        </section>
                ...
                <section class="row">
                    <section class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm border @error('subject') border border-danger @enderror" name="subject" value="{{ old('subject') }}">
                        </div>
                    </section>
                    ...
                    <section class="col-12">
                        <div class="form-group">
                            ...
                            @enderror
                            <textarea name="body" id="email_body" rows="6" class="form-control form-control-sm @error('body') border border-danger @enderror">{{ old('body') }}</textarea>
                        </div>
                    </section>
