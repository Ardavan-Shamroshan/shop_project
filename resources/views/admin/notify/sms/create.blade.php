...
@section('content')
    ...
    <section class="main-body-container">
        <section class="main-body-container-header"><h4>ایجاد اطلاعیه پیامکی</h4></section>
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.notify.sms') }}" class="btn btn-info btn-sm border rounded-pill btn-sm btn-hover color-8">« بازگشت</a>
        </section>
                ...
                <section class="row">
                    <section class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm border @error('title') border border-danger @enderror" name="title" value="{{ old('title') }}">
                        </div>
                    </section>
                    ...
                    <section class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="published_at_view" class="form-control form-control-sm @error('published_at') border border-danger @enderror" value="{{ old('published_at') }}">
                        </div>
                    </section>
                    ...
                    <section class="col-12">
                        <div class="form-group">
                            ...
                            @enderror
                            <textarea name="body" id="sms_body" rows="6" class="form-control form-control-sm @error('body') border border-danger @enderror">{{ old('body') }}</textarea>
                        </div>
                    </section>
