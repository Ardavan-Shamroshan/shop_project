...
@section('head-tag')
    <title>ویرایش  دسترسی جدید</title>
@endsection
@section('content')
    ...
    <section class="main-body-container">
        <section class="main-body-container-header"><h4>ویرایش  دسترسی</h4></section>
                ...
                <section class="row">
                    <section class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm @error('name') border border-danger @enderror" name="name" id="name" value="{{ old('name', $permission->name) }}">
                        </div>
                    </section>
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" class="form-control form-control-sm @error('description') border border-danger @enderror" name="description" id="description" value="{{ old('description', $permission->description) }}">
                        </div>
                    </section>
