...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.user.permission.create') }}" class="btn btn-info  rounded-lg btn-hover color-8 border">ایجاد دسترسی جدید</a>
            ...
            <table class="table table-striped table-hover">
                ...
                @forelse($permissions as $permission)
                    <tr>
                        ...
                        <td class="text-left">
                            <a href="{{ route('admin.user.permission.edit', $permission->id) }}" class="btn btn-primary  rounded-lg btn-hover color-4 text-white border"><i class="fa fa-pen font-size-12"></i> ویرایش</a>
