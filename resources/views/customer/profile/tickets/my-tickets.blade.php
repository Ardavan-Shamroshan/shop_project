                                    ...
                                    @foreach ($tickets as $ticket)
                                        ...
                                        <tr>
                                            ...
                                            <td class="width-16-rem text-left">
                                                <a href="{{ route('customer.profile.my-tickets.show', $ticket) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> مشاهده</a>
                                                <a href="{{ route('customer.profile.my-tickets.change', $ticket) }}" class="btn btn-warning btn-sm">
                                                    <i @class(["fa", "fa-check" => $ticket->status == 1, "fa-times" => $ticket->status == 0])></i>
