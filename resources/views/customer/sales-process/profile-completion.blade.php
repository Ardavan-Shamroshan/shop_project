                ...
                <section class="col">
                    ...
                    <section class="row mt-4">
                        <section class="col-md-9">
                            <form id="profile_completion" action="{{ route('customer.sales-process.profile-completion.completion') }}" method="post" class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                @csrf
