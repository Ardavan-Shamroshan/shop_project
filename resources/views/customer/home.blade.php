                                            ...
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="{{ route('customer.market.product', $mostVisitedProduct) }}">
                                                    <section class="product-image">
                                                        <img class=""
                                                            src="{{ $mostVisitedProduct->image['indexArray'][$mostVisitedProduct->image['currentImage']] }}"
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="{{ route('customer.market.product', $offerProduct) }}">
                                                    <section class="product-image">
                                                        <img class=""
                                                            src="{{ $offerProduct->image['indexArray'][$offerProduct->image['currentImage']] }}"
            ...
            <section class="container-xxl">
                ...
                <section class="row py-4">
                    <section class="col">
                        ...
                        <a href="{{ urldecode($bottomBanner->url) }}"> <img class="d-block rounded-2 w-100" src="{{ asset($bottomBanner->image) }}" alt="{{ $bottomBanner->title }}">
                    </section> </a>
