...
{{--                <x-jet-label for="last_name" value="{{ __('Last Name') }}"/>--}}
                ...
                @error('last_name')
                <span class="text-red-500 font-medium" role="alert">
                    <small>
                       {{ $message }}
                    </small>
                </span>
...
{{--                <x-jet-label for="password_confirmation" value="{{ __('Confirm Password') }}"/>--}}
                <x-jet-label for="password_confirmation" value="{{ __('تایید رمز عبور') }}"/>
...
{{--                    {{ __('Already registered?') }}--}}
                    {{ __('هم اکنون عضو هستید؟') }}
                </a>

                <x-jet-button class="ml-4 font-medium font-black">
{{--                    {{ __('Register') }}--}}
                    {{ __('عضویت') }}
                </x-jet-button>
            </div>
