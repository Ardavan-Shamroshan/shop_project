$(document).ready(function () {
    ...
    $('#header-notification-toggle').click(function () {
        $('#header-notification').fadeToggle(200);
    });

    $('#header-comment-toggle').click(function () {
        $('#header-comment').fadeToggle(200);
    });

    $('#header-profile-toggle').click(function () {
        $('#header-profile').fadeToggle(200);
    });


    $('.sidebar-group-link').click(function () {
        if ($(this).hasClass('sidebar-group-link-active')) {
            $(this).removeClass('sidebar-group-link-active', 1000);
            $(this).children('.sidebar-dropdown-toggle').children('.angle').addClass('fa-angle-left', 1000);
            $(this).children('.sidebar-dropdown-toggle').children('.angle').removeClass('fa-angle-down', 1000);
        } else {
            ...
            $(this).addClass('sidebar-group-link-active', 1000);
            $(this).children('.sidebar-dropdown-toggle').children('.angle').removeClass('fa-angle-left', 1000);
            $(this).children('.sidebar-dropdown-toggle').children('.angle').addClass('fa-angle-down', 1000);
        }
    });
});
